...
export type CreateAlarmClockCallback = (
	timestamp: number,
	info: string,
	cycle: AlarmClockRecordItemTask['cycle'],
) => Promise<void>;

export type UpdateAlarmClockTaskCallback = (
	timestamp: number,
	index: number,
	{ content, type, nextTime }: UpdateTimestampTarget,
) => Promise<void>;
