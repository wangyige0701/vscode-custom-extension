...
### 使用介绍
  - **上传图片：**
    ...
    本地图片直接从文件夹选择，网络图片需要在输入框内输入图片地址，图片下载并保存成功后会在下方的列表中显示
    <p align="center">
  ...
  - **多选操作：**
    ...
    <p align="center">
      <img width="200" src="https://raw.githubusercontent.com/wangyige0701/vscode-custom-extension/master/resources/docs/background/checkbox.png" />
    </p>
  ...
  - **随机切换：**
    ...
    <p align="center">
      <img width="200" src="https://raw.githubusercontent.com/wangyige0701/vscode-custom-extension/master/resources/docs/background/random-select.png" />
    </p>
  - **清除配置：**
